...
var _takeScreenshot = function(status) {
  ...
  if (pageHeight > page.viewportSize.height) {
    page.viewportSize = {
  ...
  window.setTimeout(function () {
    ...
    if (page.viewportSize.height < (page.clipRect.height + page.clipRect.top)) {
      page.viewportSize = {
        width: page.viewportSize.width,
        height: (page.clipRect.height + page.clipRect.top)
      }
    }
    if (page.viewportSize.width < (page.clipRect.width + page.clipRect.left)) {
      page.viewportSize = {
        width: (page.clipRect.width + page.clipRect.left),
        height: page.viewportSize.height
      }
    }
    if (options.clipScrollbars) {
      var oldRect = page.clipRect;
      page.clipRect = {
        top: oldRect.top,
        left: oldRect.left,
        width: oldRect.width - 17,
        height: oldRect.height - 17,
      };
    }
